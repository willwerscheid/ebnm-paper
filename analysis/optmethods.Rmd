  ...
  if (optmethod == "nlm") {
    ...
    res <- do.call(ebnm_fn, 
                   list(x = x, s = s, mode = ebnm_mode, optmethod = "trust",
                        control = list(fterm = sqrt(.Machine$double.eps), rmax = 5)))
  } else {
